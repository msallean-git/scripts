...
RestClient.post(uri_str, payload: {grant_type: "authorization_code", code: "#{ARGV[3]}", client_id: "#{ARGV[1]}", client_secret: "#{ARGV[2]}", redirect_uri: "https://www.onit.com"}){|response, request, result, &block|
	case response.code
	when 200
